      ...
      <div class="header">
         ...
         <div class="searchbox-wrapper hidden">
            <div class="inputicon-container searchicon">
               <input type="text" name="searchstore" placeholder="Search Store" maxlength="32" class="iconned"><svg fill="none" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20">
