...
<head>
   ...
   <?php
      require_once('/Users/k.vinrath/Desktop/labproject2/term-project-y3s1-db-/ggg-app/connect.php');
      include_once('/Users/k.vinrath/Desktop/labproject2/term-project-y3s1-db-/ggg-app/component/icon.php');
   ...
   <main class="storepage">
      ...
      <div class="header-container">
         ...
         <div class="subheader-container">
            ...
            <form action="backend/game/buy_game.php" method="post">
